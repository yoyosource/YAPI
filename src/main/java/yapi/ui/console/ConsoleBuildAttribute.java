...
enum ConsoleBuildAttribute {
    ...
    COLOR_BLACK_BRIGHT("black:bright", new TaskColorBright(Ansi.Color.BLACK), new TaskColor(Ansi.Color.DEFAULT)),
    COLOR_WHITE_BRIGHT("white:bright", new TaskColorBright(Ansi.Color.WHITE), new TaskColor(Ansi.Color.DEFAULT)),
    COLOR_RED_BRIGHT("red:bright", new TaskColorBright(Ansi.Color.RED), new TaskColor(Ansi.Color.DEFAULT)),
    COLOR_GREEN_BRIGHT("green:bright", new TaskColorBright(Ansi.Color.GREEN), new TaskColor(Ansi.Color.DEFAULT)),
    COLOR_BLUE_BRIGHT("blue:bright", new TaskColorBright(Ansi.Color.BLUE), new TaskColor(Ansi.Color.DEFAULT)),
    COLOR_YELLOW_BRIGHT("yellow:bright", new TaskColorBright(Ansi.Color.YELLOW), new TaskColor(Ansi.Color.DEFAULT)),
    COLOR_MAGENTA_BRIGHT("magenta:bright", new TaskColorBright(Ansi.Color.MAGENTA), new TaskColor(Ansi.Color.DEFAULT)),
    COLOR_CYAN_BRIGHT("cyan:bright", new TaskColorBright(Ansi.Color.CYAN), new TaskColor(Ansi.Color.DEFAULT)),
    ...
    COLOR_BACK_BG_BRIGHT("black:bg:bright", new TaskBGColorBright(Ansi.Color.BLACK), new TaskBGColor(Ansi.Color.DEFAULT)),
    COLOR_WHITE_BG_BRIGHT("white:bg:bright", new TaskBGColorBright(Ansi.Color.WHITE), new TaskBGColor(Ansi.Color.DEFAULT)),
    COLOR_RED_BG_BRIGHT("red:bg:bright", new TaskBGColorBright(Ansi.Color.RED), new TaskBGColor(Ansi.Color.DEFAULT)),
    COLOR_GREEN_BG_BRIGHT("green:bg:bright", new TaskBGColorBright(Ansi.Color.GREEN), new TaskBGColor(Ansi.Color.DEFAULT)),
    COLOR_BLUE_BG_BRIGHT("blue:bg:bright", new TaskBGColorBright(Ansi.Color.BLUE), new TaskBGColor(Ansi.Color.DEFAULT)),
    COLOR_YELLOW_BG_BRIGHT("yellow:bg:bright", new TaskBGColorBright(Ansi.Color.YELLOW), new TaskBGColor(Ansi.Color.DEFAULT)),
